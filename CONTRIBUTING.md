...
If you find a bug in the source code or a mistake or a typo in the documentation, you can help us by
...
* Run the full test suite, as described in the [developer documentation](#dev-hints),
...
* In GitHub, send a pull request to `photobooth-teams:master`.
...
we use the git commit messages to **generate this project change log**.
...
## Development hints for working on this project
